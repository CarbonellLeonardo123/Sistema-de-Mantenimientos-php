...
table { width:60%; margin:0 auto; border-collapse:collapse; background:#1a2a3a; border-radius:12px; overflow:hidden; }
...
.badge-cat { padding:4px 14px; border-radius:20px; font-size:13px; font-weight:bold; background:rgba(93,173,226,0.2); color:#5dade2; }
...
<div class="topbar">
  ...
  <div class="acciones-top">
    ...
    <a href="registrar.php" class="btn-nuevo">+ Nueva Categoría</a>
  </div>
</div>
<table>
  <tr>
  ...
  <tr>
    ...
    <td><span class="badge-cat"><?= htmlspecialchars($fila['nombre']) ?></span></td>
    <td>
      <a href="editar.php?id=<?= $fila['idCategoria'] ?>" class="btn-editar">Editar</a>
      <span class="sep">|</span>
      <a href="eliminar.php?id=<?= $fila['idCategoria'] ?>" class="btn-eliminar"

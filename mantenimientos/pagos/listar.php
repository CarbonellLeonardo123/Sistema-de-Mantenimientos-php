...
/** @var mysqli $conn */
$sql = "SELECT pagos.*, venta.idVenta
FROM pagos
INNER JOIN venta
ON pagos.idVenta = venta.idVenta";
...
<td>Venta #<?= $fila['idVenta'] ?></td>

<td>

<a href="editar.php?id=<?= $fila['idPago'] ?>"
class="btn-editar">
...
<a href="eliminar.php?id=<?= $fila['idPago'] ?>"
class="btn-eliminar"

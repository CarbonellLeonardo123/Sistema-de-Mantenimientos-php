...
if(isset($_POST['guardar'])){
    ...
    if($nombre != "" && $fecha != ""){
        $stmt = mysqli_prepare($conn, "INSERT INTO reportes(nombre,fecha) VALUES(?,?)");
...
<div class="formulario">
  ...
  <form method="POST">
    ...
    <input type="text" name="nombre" placeholder="Ej: Reporte de Ventas Mensual" required>
    <label>Fecha</label>
    <input type="date" name="fecha" value="<?= date('Y-m-d') ?>" required>
    <button type="submit" name="guardar" class="btn-guardar">Guardar Reporte</button>
  </form>
